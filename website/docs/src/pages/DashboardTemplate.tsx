...
import { UserCircle, TrendingUp, Users, Calendar, Activity, DollarSign, Settings, Bell, Search, Menu, X } from "lucide-react";
...
const recentSales = [
  { name: "Ram Bhardwaj", email: "rambhardwaj@gmail.com", amount: "$1,999.00", date: "Apr 18, 2025" },
  { name: "Aman Gupta", email: "akgbytese@gmail.com", amount: "$39.00", date: "Apr 17, 2025" },
  { name: "Aditya Sharma", email: "adityasharma@gmail.com", amount: "$299.00", date: "Apr 16, 2025" },
  { name: "Saurav Jha", email: "saurav@gmail.com", amount: "$99.00", date: "Apr 15, 2025" },
  { name: "Rohit Singh", email: "rohit@gmail.com", amount: "$39.00", date: "Apr 14, 2025" },
];
...
export default function DashboardPage() {
  ...
  return (
    <div className="flex h-screen bg-black">
      ...
      {/* Sidebar */}
      <div className={`fixed lg:static inset-y-0 left-0 w-64 bg-zinc-900 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-300 ease-in-out z-30`}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-zinc-950 p-4 md:p-6">
          <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
            <h3 className="text-2xl font-bold text-white mb-3 md:mb-0">Analytics Overview</h3>
            <div className="flex flex-wrap gap-2">
              <Button className="bg-zinc-800 text-white hover:bg-zinc-700">Last 7 Days</Button>
              <Button className="bg-zinc-800 text-white hover:bg-zinc-700">Last 30 Days</Button>
              <Button className="bg-white text-black hover:bg-gray-200">Export Report</Button>
            </div>
          </div>
              ...
              <CardContent className="p-4">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold">$45,231.89</h2>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-green-300 flex items-center mt-1 text-sm">
                      <TrendingUp className="h-4 w-4 mr-1" /> +180.1% from last month
                    </p>
                  </div>
              ...
              <CardContent className="p-4">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-green-300 flex items-center mt-1">
                      <TrendingUp className="h-4 w-4 mr-1" /> +19% from last month
                    </p>
                  </div>
              ...
              <CardContent className="p-4">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-green-300 flex items-center mt-1">
                      <TrendingUp className="h-4 w-4 mr-1" /> +201 since last hour
                    </p>
                  </div>
          ...
          <div className="grid grid-cols-3 mb-6">
              ...
              <CardContent className="p-4">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={revenueData}>
                    ...
                    <Bar dataKey="expenses" fill="#7f1d1d" radius={[4, 4, 0, 0]} />
                    <Bar dataKey="profit" fill="#14532d" radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
            <Card className="bg-zinc-900 text-white border border-zinc-800">
              <CardContent className="p-4">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Button className="bg-zinc-800 text-white hover:bg-zinc-700 text-sm">View Details</Button>
                </div>
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={userActivityData}>
                    ...
                    <YAxis stroke="#ccc" />
                    <Tooltip wrapperClassName="text-black" />
                    <Line type="monotone" dataKey="users" stroke="#8884d8" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} />
                  </LineChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
            <Card className="bg-zinc-900 text-white border border-zinc-800">
                <CardContent className="p-4">
                  <p className="text-lg font-semibold mb-4">Product Performance</p>
            ...
            <Card className="bg-zinc-900  w-[1200px] text-white border border-zinc-800 lg:col-span-2">
              <CardContent className="p-4">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Button className="bg-zinc-800 text-white hover:bg-zinc-700 text-sm">View All</Button>
                </div>
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-3">
                    {upcomingEvents.map((event, index) => (
                      <div key={index} className="flex items-start p-2 rounded bg-zinc-800">
                        <div className="mr-3 p-2 bg-zinc-700 rounded-lg">
                          <Calendar className="h-5 w-5 text-blue-400" />
                        </div>
                        <div>
                          <p className="font-medium">{event.title}</p>
                          <p className="text-sm text-gray-400">{event.time} - {event.date}</p>
                        </div>
                      </div>
                    ))}
                  </div>

...
export const CarouselViewport = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    return (
      <div ref={ref} className={cn("carousel-viewport overflow-hidden", className)} {...props} />
    );
  }
);

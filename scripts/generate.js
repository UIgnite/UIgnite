          ...
          files: [
            {
              ...
              cssVars: {
                theme: {
                  ...
                  '--color-light-primary': '#f7f7f7',
                  '--color-light-secondary': '#f4f4f5',
                },
              },
              css: {
                '@layer utilities': {
                  '.border-t-dark-primary': {
                    'border-top-color': 'var(--color-dark-primary)',
                  },
                  '.dark .border-t-light-primary': {
                  ...
                  '.btn-gradient-1': {
                    ...
                    'border-image':
                      'linear-gradient(to right, #1f1f1f, #fff, #1f1f1f)',
                    'border-image-slice': '1',
                  },
                  '.btn-gradient-2': {
                    'border-bottom': '2px solid',
                    'border-image':
                      'linear-gradient(to right, #fff, #1f1f1f, #fff)',
                    'border-image-slice': '1',
                  },
                  ...
                  '.animate-border': {
                    '--border-angle': '0deg',
                    background:
                      'linear-gradient(#0f172a, #0f172a) padding-box, conic-gradient(from var(--border-angle),rgba(71, 85, 105, 0.48) 80%,#6366f1 86%,#a5b4fc 90%,#6366f1 94%,rgba(71, 85, 105, 0.48))border-box',
                  ...
                  '.bg-noisy': {
                    'background-image':
                      "url('https://web.archive.org/web/20230410192050im_/https://liveblocks.io/images/noise.png')",
                    'background-repeat': 'repeat',
                    'background-size': '182px',
                    opacity: '0.03',
                  },
                  '.IllustrationPresence_mask__Fkl05': {
                    '-webkit-mask-image':
                      'linear-gradient(#000, #000 66%, transparent)',
                    'mask-image':
                      'linear-gradient(#000, #000 66%, transparent)',
                  ...
                  '.slider::-webkit-slider-thumb': {
                    ...
                    appearance: 'none',
                    '@apply':
                      'bg-neutral-200 rounded-full size-2 cursor-pointer',
                  },

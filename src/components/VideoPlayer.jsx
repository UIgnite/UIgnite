...
export default function VideoPlayer({}) {
  ...
  }, [setPlayed, videoRef.current, playing]);

  React.useEffect(() => {
    // an abort controller to abort all the events registered
    // after useEffect is called again
  ...
  }, [containerRef.current, setFullScreenMode, fullScreenMode]);
  ...
  return (
    ...
    >
      ...
      <img
        ...
        src="https://picsum.photos/seed/picsum/1482/812"
      />
      <div

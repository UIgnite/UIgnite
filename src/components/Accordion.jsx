...
const Accordion = ({title, content, className="", defaultOpen = false, open=false, isOpen=null, onToggle }) => {
  ...
  return (
    <>
    <div>
      <div onClick={onToggle ?? toggleAccordion} className={cn('cursor-pointer bg-gray-800  hover:bg-gray-900 flex  items-center justify-between min-w-2xs  min-h-md ease-in-out')}>

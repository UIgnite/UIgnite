...
const MessageBot = ({ orgName="UIgnite", themeColor = "bg-gray-800" , url, alt }) => {
        ...
        {isOpen && (
          <div className=" fixed bottom-23 right-8 w-80 h-120 bg-white rounded-lg " >
            ...
            <div className="flex flex-col ">
              ...
              <div className={`p-3 ${themeColor} text-white flex justify-between items-center rounded-t-lg`}>
                <span>{orgName}</span>
                <button className=" cursor-pointer p-1 text-white text-sm font-bold" 

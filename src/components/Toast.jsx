...
export default function ToastUi({ title, options, ref }){
    return (
        <div ref={ref} className={cn("fixed -bottom-20 right-10 transition-all rounded-lg border border-neutral-300 min-w-[300px] bg-neutral-100 dark:bg-neutral-950 dark:border-neutral-700 shadow px-5 py-3", options.containerClassName)}>

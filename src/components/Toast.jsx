...
export default function ToastUi({ idx, title, options, hovered = false }) {
  return (
    <div
      ...
      className={cn(
        "fixed right-10 transition-all rounded-lg border border-neutral-300 min-w-[300px] bg-neutral-100 dark:bg-neutral-950 dark:border-neutral-700 shadow-lg px-5 py-3",

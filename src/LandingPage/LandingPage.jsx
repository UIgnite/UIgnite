...
import darkLogo from "../assets/uidark.png";
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full" 
           style={{
             background: 'radial-gradient(circle at center, rgba(128, 90, 213, 0.1) 0%, transparent 80%)',
           }}>
        <svg className="w-full h-full absolute top-0 left-0" viewBox="0 0 1920 1080" preserveAspectRatio="xMidYMid slice">
          <defs>
          ...
          {Array(20).fill(0).map((_, i) => {
            ...
            return (
              <path 
                key={`h-${i}`} 
                d={`M 0,${y} C ${controlPointOffset},${y - 50} ${1920 - controlPointOffset},${y - 50} 1920,${y}`}
          ...
          {Array(20).fill(0).map((_, i) => {
            ...
            return (
              <path 
                key={`v-${i}`} 
                d={`M ${x},0 C ${x + controlPointOffset},400 ${x + controlPointOffset},700 ${x},1080`}
                stroke="rgba(100, 100, 100, 0.2)"
                fill="none"
                strokeWidth="1"
              />
      ...
      <div className="relative z-10">
        ...
        <div className="mt-12 px-8 md:px-12 min-w-[1200px] min-h-screen flex items-center justify-center">
          <div className="max-w-6xl mx-auto text-center">
            ...
            Immerse yourself in a design journey like never before. Experience our UI library flexible, accessible, and crafted for effortless creativity. It's smoother, smarter, and better than your ordinary UI kits.
            </p>
